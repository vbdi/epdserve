...
python -m epdserve.api_server.distserve_api_server \\
    --host 0.0.0.0 \\
    --port {port} \\
    --model {args.model} \\
    --tokenizer {args.model} \\
    \\
    --encoding-data-parallel-size {encoding_dp} \\
    --encoding-tensor-parallel-size {encoding_tp} \\
    --encoding-pipeline-parallel-size {encoding_pp} \\
...
import epdserve
from epdserve import orchestrator
from epdserve import utils
from epdserve.llm_async import AsyncLLM
from epdserve.request import SamplingParams
from epdserve.utils import random_uuid, set_random_seed
...
if __name__ == "__main__":
    ...
    orchestrator.add_orchestrator_cli_args(parser)
