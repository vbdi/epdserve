...
# sys.path.insert(0, os.path.abspath(os.path.dirname(__file__) + '/epd/evaluation/2-benchmark-serving'))
import distserve
...
if __name__ == "__main__":
    ...
    parser.set_defaults(
        ...
        num_prompts_req_rates=[(100,3)], #(num_prompts, request_rate)
        ...
        # prompt=f"I have provided multiple pictures in the input. I want you to decribe the details of the picture. While describing, please make sure you do not miss any important details. Please keep the output concise yet it should also be meaningful and have a lot of insight. Further, make sure you explain things that can be missed by an average individual."
